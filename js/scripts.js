$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Simonos ir Juliaus vestuvės",

            // Event start date
            start: new Date('Jul 22, 2020 15:00'),
            ...
            end: new Date('Jul 23, 2020 12:00'),

            // Event Address
            address: 'Babtyno - Žemaitkiemio dvaras, Kauno r. Babtų sen. Žemaitkiemio 10',

            // Event Description
            description: "Nekantraujame jus pamatyti mūsų šventėje. Iškilus klausimams kreipkitės į Julių +37065310806."
        }
    });
...
// Google map
function initMap() {
    var location = {lat: 55.065719651745475, lng: 23.79233142443652};
...
function initBBSRMap() {
    var la_fiesta = {lat: 55.065719651745475, lng: 23.79233142443652};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
